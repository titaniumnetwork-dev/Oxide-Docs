...
title: bare-mux
---
Bare mux is system for managing http transports in a project such as [Ultraviolet](https://github.com/Titaniumnetwork-dev/Ultraviolet) and [Scramjet](https://github.com/MercuryWorkshop/Scramjet).
...
Specifically, this is what allows proxies such as [Nebula](/serivices/nebula) to switch HTTP transports seamlessly.
