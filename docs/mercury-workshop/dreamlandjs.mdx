...
title: dreamland.js
slug: dreamlandjs
description: dreamland is a reactive JSX-inspired UI library with no virtual dom and no build step.
---

<h1 align="center">dreamland.js</h1>
<p align="center"><img src="https://github.com/MercuryWorkshop/dreamlandjs/blob/master/static/logo.png?raw=true" alt="logo" height="100" /></p>
...
#### https://github.com/MercuryWorkshop/dreamlandjs