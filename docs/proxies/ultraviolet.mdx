...
## Setup
Ultraviolet works by intercepting HTTP requests with a service worker script that follows the TompHTTP specifications. More information regarding TompHTTP can be found <a href="/tomphttp">here</a>.
...
<p align="center"><img src="https://raw.githubusercontent.com/titaniumnetwork-dev/Ultraviolet-Static/main/public/uv.png" height="200"></img></p>
