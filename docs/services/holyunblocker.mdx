...
This page is about the React rewrite of Holy Unblocker.
For the legacy version by Quite A Fancy Emerald, please click [here](https://github.com/QuiteAFancyEmerald/Holy-Unblocker).

:::

[https://holyubofficial.net](https://holyubofficial.net)
