---
title: "HSTS Extension Bypass"
slug: "HSTS_Extension_Bypass"
description: "Changes method of communication to confuse extensions"
---

# HSTS Extension Bypass
This will only work with certain blocking extensions, read before replying. If it doesn't work, it doesn't hurt to try it anyways.
