...
title: "cauDNS"
slug: "cauDNS"
description: "cauDNS utilizes DNS settings to bypass web restrictions like extensions"
---

# cauDNS

cauDNS disables extensions through DNS filtering such as GoGuardian, CKAuth, Securly, and more.
