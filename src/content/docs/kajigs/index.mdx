---
title: Kajigs
description: Information about Kajigs and their role in TitaniumNetwork.
sidebar:
  order: 1
---
...
Kajigs are tools or exploits for bypassing restrictions on managed devices, or other tools that can be useful in bypassing.
The majority of Kajigs are for Chromebooks.

#### Where can I find them?

Kajigs can be found in the [TitaniumNetwork Discord server](https://discord.gg/unblock) after verifying. Kajigs are located in the `kajig-the-things` category. This category has several kajig-related channels listed below.
...
<div id="kajigs">
  ...
  :::note
  If you want to, you can change your kernver after [Unenrolling](/kajigs/unenrollment) by using the "Reset kernel rollback version" payload in [Sh1mmer](/kajigs/sh1mmer).
  :::
  ...
  :::note
  If you are on Kernver 1, you can recover to any version. However, if a kajig is listed as Kernver 1, it can only be done on r110 or lower.
  :::
</div>
