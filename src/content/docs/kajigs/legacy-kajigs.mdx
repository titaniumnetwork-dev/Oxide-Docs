---
title: Legacy Kajigs
description: Documentation for Legacy Kajigs.
...
- Patched: these kajigs have been patched by software vendors. THIS DOES NOT MEAN THE KAJIG IS UNUSABLE. For example, see "Chrome OS Downloads - Downgrade your Chrome OS"
...
- To change the title, replace the text in the quotes on line 5 with your own title
...
[TN Discord Message Reference](https://discord.com/channels/419123358698045453/1033121753263771709)
...
[TN Discord Message Reference](https://discord.com/channels/419123358698045453/1040775494406250548)
...
- Sign out
- Turn Wi-Fi off
- Enable ChromeVox (<kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>Z</kbd>)
- Open a kiosk app
- Spam <kbd>Search</kbd> + <kbd>O</kbd> + <kbd>K</kbd> (you do have to re-click o and k)
...
When you connect to a Wi-Fi without the custom DNS the policy will reload to normal but some changes will persist, more testing is needed. This is useful because most root exploits require ARC in some form.
...
[TN Discord Message Reference](https://discord.com/channels/419123358698045453/1040639727595950180)
...
- Go to [https://chrome.google.com/webstorex](https://chrome.google.com/webstorex) and run this bookmarklet
...
- Visit [https://chrome.google.com/](https://chrome.google.com/)
...
- Go to [https://chrome.google.com/sync](https://chrome.google.com/sync)
...
## Downgrade your Chrome OS (Chrome OS Downloads)

This provides a basic tool required for many exploits as a prerequisite.

Chrome OS Downloads is a website which enables you to download old versions of Chrome OS for your Chromebook.
...
[Chrome OS Downloads](https://cros.download/)

**Maintained by Mercury Workshop**
...
The full list is here: [https://peter.sh/experiments/chromium-command-line-switches/](https://peter.sh/experiments/chromium-command-line-switches/)
...
- Know the credentials of your School's Wi-Fi or utilize a hotspot
- Go to `chrome:policy` and <kbd>Ctrl</kbd> + <kbd>F</kbd> for `deviceopennetworkconfig`; click show more
...
ONC: [https://cdn.discordapp.com/attachments/1042601318105239562/1042928899371323402/bypass.onc](https://cdn.discordapp.com/attachments/1042601318105239562/1042928899371323402/bypass.onc)
...
Make sure to downgrade to chrome OS v81 or lower first: "Chrome OS Downloads - Downgrade your Chrome OS"
...
- Once you login go quickly to the Incognito Tab and do <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>N</kbd>
...
- Open Task Manager
- Press <kbd>Search</kbd> + <kbd>Esc</kbd>
...
[Required personalDNSfilter app](https://f-droid.org/en/packages/dnsfilter.android/)
...
- `45.128.53.172` (watch this tutorial [https://youtu.be/qo-hx0tOYxI](https://youtu.be/qo-hx0tOYxI) (only works with goguardian
- `129.213.58.41`
- `51.161.64.196`

### Extras

- Wi-Fi network + usb tethering
- cellular network + hotspot
- cellular network + hotspot app

You may need to update the DNS servers on your current phone Wi-Fi network.
...
- Visit `chrome://settings/signOut` (the O must be capital) and click the blue button. If this is "blocked\_by\_administrator", DM `SprinkzMC#8421` for an alternate URL.
