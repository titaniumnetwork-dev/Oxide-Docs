...
It requires you to be on v132 or lower, which can be achieved by downgrading to v132 LTS. You can also get the bundled update with Sh1mmer, by building with its [update payload](/kajigs/sh1mmer#update-payload)
