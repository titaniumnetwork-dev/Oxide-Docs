---
title: Break your Chromebook
description: Stop doing pencil
keywords: ["unenrollment", "chromeos exploits", "any kernver", "stupid", "dumb", "you're a dumbass if you use this"]
kernver: 0
unenrollment: true
---
...
3. Sh1mmer USB
4. However much money it takes to get a replacement Chromebook from your district
...
2. Look around the Chromebook motherboard and look for a small 8-pin chip with pins sticking out or in. These chips tend to have WINBOND or GIGADEVICE branding, and may either say 25Q64[xx] or 25Q128[xx] right below the branding. You may need to flip over the motherboard to find this chip.
    ...
    :::
    <div style="display: flex; flex-direction: row; justify-content: space-evenly;"><img src="/soic-8-chip.jpg" width="256"/><img src="/wson-8-chip.png" width="256"/></div>
3. Now you’re going to have to use the picture(s) below as reference on what pins to bridge, as this is important. These are the charts for both of the chips:
    <div style="display: flex; flex-direction: row; justify-content: space-evenly;"><img src="/soic-8-chart.png" width="256"/><img src="/wson-8-chart.png" width="256"/></div>
4. “How do you bridge these pins?” This is where the supplies you got earlier comes into play, as they’ll be how you can bridge these pins.
    ...
    * Blue: Tape
    ...
    <div style="display: flex; flex-direction: row; justify-content: space-evenly;"><img src="/soic-8-bridge.png" width="256"/><img src="/wson-8-bridge.png" width="256"/></div>
