---
title: BadRecovery
description: BadRecovery is an unenrollment exploit for Kernver 3.
author: OlyB
keywords: ["unenrollment", "chromeos exploits", "kernver 3"]
link: https://github.com/BinBashBanana/BadRecovery
kernver: 3
unenrollment: true
---
...
On postinst and postinst\_sym payloads, BadRecovery will start partway through the recovery process.

> \[!NOTE]\
> If using postinst\_sym and BadRecovery does not start, the path to the internal drive is incorrect.
