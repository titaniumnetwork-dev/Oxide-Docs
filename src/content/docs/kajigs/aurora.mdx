...
# IMPORTANT NOTICE
Usage of Aurora is no longer recommended as it's unmaintained and unstable. Please consider using [Priism](https://github.com/xmb9/Priism) instead.
...
Prebuilts are located at [https://dl.mrwork.shop/aurora](https://dl.mrwork.shop/aurora)
