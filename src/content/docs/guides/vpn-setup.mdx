---
title: VPN Guide
description: In this guide we cover creating our own VPN setup.
keywords: ["vpn"]
---
...
Edit `/etc/ufw/before.rules` above `*filter`, insert (replacing DEVICE\_HERE with your device name):
