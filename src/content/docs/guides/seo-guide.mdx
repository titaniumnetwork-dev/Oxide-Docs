...
<html lang="en">
  <head>
	...
	<meta name="twitter:description" content="InvisiProxy, an official flagship Titanium Network site, can bypass web filters regardless of whether it is an extension or network-based. Being a secure web proxy service, it supports numerous sites while being updated frequently and concentrating on detail with design, mechanics, and features.">
...
<div id="mainbody" class="fullwidth">
        ...
        <img id="logo" width="40px;" height="40px;" src="example" alt="InvisiProxy's logo; an official flagship Titanium Network site, can bypass web filters."></img>
        <div id="scrollfix"><br></div>
        <div id="desc">
            <div id="info" class="box-info box-large text-center textm">
                <h2>What is InvisiProxy?</h2>
                <p>InvisiProxy, an official flagship Titanium Network site, can bypass web filters or "blockers" regardless of whether it is an extension or network-based.</p>
