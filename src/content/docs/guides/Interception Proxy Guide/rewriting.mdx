...
The [DOMUtils libraries](https://domutils.js.org/index.html) will take you a long way, and is recommended for beginners.
The Rust crate [tl](https://docs.rs/tl/latest/tl/) is recommended for speed, however you can use [tljs](https://github.com/y21/tljs) if you don't want to write Rust code, but still take advantage of the performance gains.
