...
3. Have your codebase use these methods defined on the config. Remember to eval the stringified version on the SW, for when decoding in the SW, and then stringify it again for the injects.
