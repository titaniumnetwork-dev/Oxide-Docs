...
:::note
TODO: Right now, WPT-diff does not support Test Maps, but it will in the near future. This is a planned feature, so this section will remain as a placeholder for now to remind me to finish it.
:::
...
4. Run your unit tests, including your package structure tests.
5. Test for site regression with your Playwright Site Integration Tests.
6. [Upload your artifact as a CI build](https://github.com/marketplace/actions/create-release) if these tests are successful.
7. Run WPT-Diff Test Map on affected modules to prevent regression for your final NPM package and just for helpful insight when reviewing commits and PRs.
8. Publish your package to NPM if the version in the package.json is bumped and all tests pass.
