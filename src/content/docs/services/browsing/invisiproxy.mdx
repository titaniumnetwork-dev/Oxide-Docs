---
title: ⭐ InvisiProxy LTS (v6.x.x)
description: InvisiProxy LTS is a web proxy service that helps you access websites that may be blocked by your network, government or policy all within your browser with no download or setup. It does this securely and with additional privacy features. Browse Tor/Onion sites in any browser, hide browsing activity and bypass filters.
keywords: ["proxy sites"]
github: "https://github.com/QuiteAFancyEmerald/InvisiProxy"
official-link: "https://invisiproxy.com"
sidebar:
  order: 1
---

<img align="center" src="https://raw.githubusercontent.com/titaniumnetwork-dev/InvisiProxy/master/views/assets/img/github_banner.png" />

<img align="left" width="40px" src="https://raw.githubusercontent.com/titaniumnetwork-dev/InvisiProxy/master/views/assets/img/logo_github.png" />
...
:::caution
If you are going to self-host InvisiProxy LTS please switch to the PRODUCTION branch for filter evasion features. The master branch is intended for development work and a highly readable source for developers. You can select a production branch (v6.x\_production) via the branches dropdown.
:::
...
<img src="https://raw.githubusercontent.com/titaniumnetwork-dev/InvisiProxy/master/views/assets/img/preview/hu-v6.4.3-preview.png" />

<img src="https://raw.githubusercontent.com/titaniumnetwork-dev/InvisiProxy/master/views/assets/img/preview/hu-v6.3.0-preview-settings.png" />

## Free Deployments

[![Deploy to Koyeb](https://binbashbanana.github.io/deploy-buttons/buttons/remade/koyeb.svg)](https://app.koyeb.com/deploy?name=InvisiProxy\&type=git\&repository=QuiteAFancyEmerald%2FInvisiProxy\&branch=master\&builder=buildpack\&env%5B%5D=\&ports=8080%3Bhttp%3B%2F)
[![Deploy to Oracle Cloud](https://binbashbanana.github.io/deploy-buttons/buttons/remade/oraclecloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/QuiteAFancyEmerald/InvisiProxy/archive/refs/heads/master.zip)

<details><summary>Alternative Free Sources</summary></details>
...
- Head to the official [Codespaces](https://github.com/codespaces) website (ensure you have a GitHub account already made)
...
### Example: v6.x\_production instead of master
...
- [https://docs.titaniumnetwork.org/guides/nginx/](https://docs.titaniumnetwork.org/guides/nginx/)
- [https://docs.titaniumnetwork.org/guides/vps-hosting/](https://docs.titaniumnetwork.org/guides/vps-hosting/)
- [https://docs.titaniumnetwork.org/guides/dns-setup/](https://docs.titaniumnetwork.org/guides/dns-setup/)
...
- `disguiseFiles`: Enable DOM masquerading which obfuscates real the real content fetches for InvisiProxy LTS. This is done through disguising requests, decompressing and then reconstructing the DOM tree.
...
Simply host Tor using this guide: [https://tb-manual.torproject.org/installation](https://tb-manual.torproject.org/installation)

Alternative Guide (for CLI): [https://community.torproject.org/onion-services/setup/install](https://community.torproject.org/onion-services/setup/install)
...
Download the latest release [here](https://github.com/QuiteAFancyEmerald/InvisiProxy/releases/latest/download/GAMES.md) and extract it within a folder called `/views/archive`.
...
[This](https://github.com/QuiteAFancyEmerald/InvisiProxy/releases/latest/download/TODO.md) is our nonexhaustive todo list for InvisiProxy LTS v6.x.x and above. Release for production will be v7.x.x and above.
...
- [Crunchbits](https://crunchbits.com/) ( Current Hosting Provider)
- [Greencloud](https://greencloudvps.com) (Paid)
- [Oracle Cloud](https://www.oracle.com/cloud) (Free, Paid, Dedicated)
- [Azure](https://azure.microsoft.com) (Free and Paid)
...
<img src="https://raw.githubusercontent.com/titaniumnetwork-dev/InvisiProxy/master/views/assets/img/dnssetup.png" width="500" />
...
- If you prefer to obtain premium domains (TLDs) then use [Porkbun](https://porkbun.com), which offers domains for amazing prices. Literally a `.org` domain normally costs around $5 first year.
...
Preferably if you have your own device use Visual Studio Code. Pretty much the best option you can get but obviously this is an opinion. Also make sure you have [Node.JS](https://nodejs.org/) installed on your machine.
...
Now simply add the folder you cloned this repo in in VSC. Then run `npm install{:sh}`. I recommend that if you are releasing this publically on GitHub that you add a `.gitignore` in your root directory with the following exclusions:
...
- Make an account: [https://gitpod.io/](https://gitpod.io/)
- Fork this repo and enter in this URL to setup your workspace: [https://gitpod.io#https://github.com/YourNameHere/InvisiProxy/](https://gitpod.io#https://github.com/YourNameHere/InvisiProxy/)

Use the same steps above by running `npm install{:sh}` in your repository and adding a `.gitignore` in your root directory specifying to exclude `node_modules`.
...
- [**Epoxy Transport**](/technologies/epoxy-server)
- [**Wisp Server Node**](/technologies/wisp-server-node)
- [**Wisp Server Python**"](/technologies/wisp-server-python)
- [**EpoxyTransport**](/technologies/epoxy-transport.mdx)
- [**CurlTransport**](/technologies/curl-transport.mdx)
- [**Bare-Mux**](/transports/bare-mux)
- [**DetailedDetector**](https://gist.github.com/BinBashBanana/a1fd7345e2d86e69d5a532f16cbdbdaa)
